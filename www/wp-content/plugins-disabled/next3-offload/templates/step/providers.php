<div class="providers-data">
    <form method="post" action="#" class="next3offload-settings" name="next3offload-settings">
        ...
        <!--h3 class="next3offload-heading"><?php echo esc_html('Providers', 'next3-offload');?></h3-->
        ...
        if( !empty($providers) ){
            ...
            <div class="next3offload-provider-data render-filed-data provider-<?php echo esc_attr($k);?> <?php echo ($provider == $k) ? esc_attr('activediv') : '';?>">
                ...
                <a href="<?php echo esc_url($docs_link);?>" target="_blank"><?php echo esc_html( 'Documentation', 'next3-offload');?></a>
                <?php }?>
                </h3>
                <?php
                    if( !empty($field) ){
                            ...
                            ?>
                                <div class="next3offload-types">
                                    <div class="next3offload-types-header">
                                        ...
                                        <?php if( !empty($f_title) ){?><span><?php echo esc_html($f_title );?></span><?php }?>
                                        </label>
        ...
        <div class="next3offload-footer">
            <div class="next3offload-admin-setting-button border-top">
                <a href="<?php echo next3_admin_url( 'admin.php?page=next3aws&step=license' );?>" class="next3offload-submit"><i></i> <?php echo esc_html('Previous', 'next3-offload');?></a>
            </div>
            <div class="next3offload-admin-setting-button border-top">

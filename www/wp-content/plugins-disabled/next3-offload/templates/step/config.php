<div class="providers-data">
    ...
    <!--h3 class="next3offload-heading"><?php echo esc_html__('Configuration', 'next3-offload');?></h3-->
                    ...
                    ?>
                        ...
                        ?>
                                ...
                                <div class="nx_div_td">
                                    ...
                                    if( !empty($default_bucket) && in_array($provider, ['aws', 'digital', 'wasabi'])){
                                        ...
                                        if( $status_public == true){
                                            ?>
                                            <p><strong><?php echo esc_html__('Wraning: Block All Public Access is currently enabled.', 'next3-offload');?></strong></p>
                                            <!--p><?php echo __('If you\'re not planning on using Amazon CloudFront for delivery, you need to <strong>Disabled Block All Public Access</strong>.', 'next3-offload');?></p-->
                                            ...
                                            ?>
                                            <p><strong><?php echo esc_html__('Block All Public Access Disabled.', 'next3-offload');?></strong></p>
                            ...
                            <div class="nx_div_tr bucket_footer">
                                ...
                                <button type="button" class="nx3_buccket_new"><?php echo esc_html__('Create new Bucket', 'next3-offload');?></button>
                                <button type="button" class="nx3_buccket_action nx3_exiting_bucket_btn backcolor" data-type="settings"><?php echo esc_html__('Save Bucket Settings', 'next3-offload');?></button>
                            </div>

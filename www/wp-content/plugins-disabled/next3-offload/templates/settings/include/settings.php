<?php do_action('next3aws-settings-content-before');?>
<?php 
            ...
            <div class="next3aws-footer-content">
                ...
                <div class="files-table next3_enable_path_section <?php echo esc_attr( ($enable_path != 'yes') ? 'next3-closed' : '');?>">
                    <div class="settings-item">
                        ...
                        ?>
                        <label>
                            <input type="text" name="next3settings[storage][upload_path]" id="next3-upload-path" class="settings-input" placeholder="wp-content/uploads/" value="<?php echo esc_attr( $upload_path );?>">
                        </label>
                    </div>
            ...
            <div class="next3aws-footer-content next3_enable_file_extention <?php echo esc_attr( ($enable_mine != 'yes') ? 'next3-closed' : '');?>">
                ...
                <div class="files-table">
                    <div class="settings-item">
                        ...
                        $options_file_type = apply_filters('next3/selected/file/types', array_merge(['all'], next3_allowed_mime_types()));
                        ?>
...
<?php do_action('next3aws-settings-content-after');?>
...
class ief_data_query{

	private $table;
	
	public function __construct(){
	  global $wpdb;
	  $this->table = $wpdb->prefix.'story_requests';
	}
	...
	*/
	public function getAllRecords($limit = 0) {
	  global $wpdb;
	  $sql = "SELECT $this->table.id,$this->table.wb_fullname,$this->table.wb_email,$this->table.wb_phone,$this->table.wb_location,$this->table.wb_message,$this->table.cv,$this->table.ip_addr,$this->table.added_on FROM {$this->table}";
	  if($limit > 0){
	  	$sql.= " LIMIT 0, $limit ";
	  }

...
function charitable_get_terms_and_conditions() {
	...
	$content = ( $custom_content !== false ) ? $custom_content : apply_filters( 'the_content', get_post_field( 'post_content', charitable_get_option( 'terms_conditions_page', 0 ), 'display' ) );

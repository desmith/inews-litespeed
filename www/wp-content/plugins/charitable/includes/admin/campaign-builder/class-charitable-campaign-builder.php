...
if ( ! class_exists( 'Charitable_Campaign_Builder' ) ) :
	...
	class Charitable_Campaign_Builder {
		...
		public function get_default_settings() {
			...
			$campaign_name = isset( $_POST['campaign_name'] ) && '' !== trim( $_POST['campaign_name'] ) ? esc_html( $_POST['campaign_name'] ) : esc_html__( 'New Campaign', 'charitable' );
			...
			*/
			...
			wp_enqueue_script(
				...
				array(
					'jquery',
					'charitable-utils',
					// 'charitable-admin-builder-templates',
					'jquery-ui-sortable',
					'jquery-ui-draggable',
					'tooltipster',
					'jquery-confirm',
			...
			$strings = array(
				...
				'upgrade'                           => array(
					'pro'       => array(
						...
						'doc'          => sprintf(
							'<div class="lite-promo"><span>Bonus:</span> Charitable Lite save <strong class="percent">$300 or more</strong> off the regular price, automatically applied at checkout!</div><div class="already-purchased-div"><a href="%1$s" target="_blank" rel="noopener noreferrer" class="already-purchased">%2$s</a></div>',
				...
				>
					...
					<div class="charitable-toolbar">
						...
						<div class="charitable-center">
							...
							<?php echo esc_html__( 'Now editing', 'charitable' ); ?>

							<span class="charitable-edit-campaign-title-area">
								<input id="charitable_settings_title" name="title" disabled="true" class="charitable-center-form-name charitable-form-name" value="<?php echo esc_html( isset( $this->campaign_data['title'] ) ? $this->campaign_data['title'] : esc_html__( 'New Campaign', 'charitable' ) ); ?>" /><a href="#" class="charitable-title-edit" title="<?php echo esc_html__( 'Edit Campaign Title', 'charitable' ); ?>"><img class="chartiable-edit-campaign-title-icon" width="18" height="18" src="<?php echo charitable()->get_path( 'assets', false ) . 'images/icons/edit.png'; ?>" /></a>
							</span>
						...
						<div class="charitable-right">
							...
							<?php
							/*
							<button id="charitable-preview-btn" class="charitable-btn charitable-btn-toolbar charitable-disabled" title="<?php esc_attr_e( 'Preview Campaign Ctrl+P', 'charitable' ); ?>">

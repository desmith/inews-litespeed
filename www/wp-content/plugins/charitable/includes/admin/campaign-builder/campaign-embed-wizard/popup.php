...
<div id="charitable-admin-campaign-embed-wizard-container" class="charitable-admin-popup-container">
	<div id="charitable-admin-campaign-embed-wizard" class="charitable-admin-popup" data-pages-exists="<?php echo esc_attr( $pages_exists ); ?>">
		<div class="charitable-admin-popup-content">
			<h3><?php esc_html_e( 'Embed in a Page', 'campaign-lite' ); ?></h3>
			<div id="charitable-admin-campaign-embed-wizard-content-initial">
				<p class="no-gap"><b><?php esc_html_e( 'We can help embed your campaign with just a few clicks!', 'campaign-lite' ); ?></b></p>

				<?php if ( ! empty( $args['user_can_edit_pages'] ) ) : ?>
					<p><?php esc_html_e( 'Would you like to embed your campaign in an existing page, or create a new one?', 'campaign-lite' ); ?></p>
				<?php endif; ?>
			</div>

			<?php if ( ! empty( $args['user_can_edit_pages'] ) ) : ?>
				<div id="charitable-admin-campaign-embed-wizard-content-select-page" style="display: none;">
					<p><?php esc_html_e( 'Select the page you would like to embed your campaign in.', 'campaign-lite' ); ?></p>
				</div>
				<div id="charitable-admin-campaign-embed-wizard-content-create-page" style="display: none;">
					<p><?php esc_html_e( 'What would you like to call the new page?', 'campaign-lite' ); ?></p>
				</div>
				<div id="charitable-admin-campaign-embed-wizard-section-btns" class="charitable-admin-popup-bottom">
					<button type="button" data-action="select-page" class="charitable-admin-popup-btn"><?php esc_html_e( 'Select Existing Page', 'campaign-lite' ); ?></button>
					<button type="button" data-action="create-page" class="charitable-admin-popup-btn"><?php esc_html_e( 'Create New Page', 'campaign-lite' ); ?></button>
				</div>
				<div id="charitable-admin-campaign-embed-wizard-section-go" class="charitable-admin-popup-bottom charitable-admin-popup-flex" style="display: none;">
					...
					<input type="text" id="charitable-admin-campaign-embed-wizard-new-page-title" value="" placeholder="<?php esc_attr_e( 'Name Your Page', 'campaign-lite' ); ?>">
					<button type="button" data-action="go" class="charitable-admin-popup-btn"><?php esc_html_e( 'Let’s Go!', 'campaign-lite' ); ?></button>
				</div>
			<?php endif; ?>
			<div id="charitable-admin-campaign-embed-wizard-section-toggles" class="charitable-admin-popup-bottom">
				<p class="secondary">
					...
					printf(
						wp_kses( /* translators: %1$s - Video tutorial toggle CSS classes, %2$s - shortcode toggle CSS classes. */
							__( 'You can also <a href="#" class="%1$s">embed your campaign manually</a> or <a href="#" class="%2$s">use a shortcode</a>', 'campaign-lite' ),
							[
								'a' => [
									'href'  => [],
									'class' => [],
				...
				<div id="charitable-admin-campaign-embed-wizard-shortcode-wrap" style="display: none;">
					...
					<span id="charitable-admin-campaign-embed-wizard-shortcode-copy" title="<?php esc_attr_e( 'Copy embed code to clipboard', 'campaign-lite' ); ?>">
			...
			<div id="charitable-admin-campaign-embed-wizard-section-goback" class="charitable-admin-popup-bottom" style="display: none;">
				<p class="secondary">
					<a href="#" class="charitable-admin-popup-toggle initialstate-toggle">« <?php esc_html_e( 'Go back', 'campaign-lite' ); ?></a>
				</p>
			</div>
		</div>

...
if ( ! class_exists( 'Charitable_Field_Social_Sharing' ) ) :
	...
	class Charitable_Field_Social_Sharing extends Charitable_Builder_Field {
		...
		public function settings_section_top( $field_id = false, $campaign_data = false ) {
			...
			$message = '<p> <a class="charitable-field-edit" data-type="' . $this->edit_type . '" data-section="' . $this->edit_section . '" href="http://wpcharitable.com/campaign-builder/fields/social-sharing">' . esc_html__( 'Learn how to add additional social networks to share.', 'charitable' ) . '</a></p>';

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Convert_Kit' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Convert_Kit {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Convert Kit', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Convert_Kit();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Aweber' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Aweber {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'AWeber', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Aweber();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_Square' ) ) :

	/**
	 * Square subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Payment_Square {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Square', 'charitable' );
		...
		public function sidebar_tab() {
			...
			echo '<a href="#" class="charitable-panel-sidebar-section charitable-panel-sidebar-section-' . $this->slug . ' ' . $active . '" data-section="' . $this->slug . '">'
				. '<img class="charitable-builder-sidebar-icon" src="' . charitable()->get_path( 'assets', false ) . 'images/campaign-builder/settings/payment/' . esc_attr( $this->slug ) . '.png" />'
				. $this->primary_label

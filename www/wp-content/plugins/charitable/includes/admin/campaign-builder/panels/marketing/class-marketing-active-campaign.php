...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Active_Campaign' ) ) :

	/**
	 * Active_Campaign subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Active_Campaign {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Active Campaign', 'charitable' );
		...
		public function panel_content() {
			...
			<div class="charitable-panel-content-section charitable-panel-content-section-parent-marketing charitable-panel-content-section-<?php echo esc_attr( $this->slug ); ?> <?php echo esc_attr( $active ); ?>" style="<?php echo esc_attr( $style ); ?>">
				...
				<?php
					...
					do_action( 'charitable_campaign_builder_before_marketing_' . esc_attr( $this->slug ) );

				?>

				<?php $panel->education_marketing_text( $this->primary_label, esc_attr( $this->slug ) ); ?>

				<?php

					do_action( 'charitable_campaign_builder_after_marketing_' . esc_attr( $this->slug ) );
	...
	new Charitable_Builder_Panel_Marketing_Active_Campaign();

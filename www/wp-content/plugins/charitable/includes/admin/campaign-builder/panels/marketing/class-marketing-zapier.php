...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Zapier' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Zapier {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Zapier', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Zapier();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Mailpoet' ) ) :

	/**
	 * Mailpoet subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Mailpoet {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Mailpoet', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Mailpoet();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Campaign_Monitor' ) ) :

	/**
	 * Campaign_Monitor subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Campaign_Monitor {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Campaign Monitor', 'charitable' );
		...
		public function panel_content() {
			...
			<div class="charitable-panel-content-section charitable-panel-content-section-parent-marketing charitable-panel-content-section-<?php echo esc_attr( $this->slug ); ?> <?php echo esc_attr( $active ); ?>" style="<?php echo esc_attr( $style ); ?>">
				...
				<?php $panel->education_marketing_text( $this->primary_label, $this->slug ); ?>
	...
	new Charitable_Builder_Panel_Marketing_Campaign_Monitor();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Constant_Contact' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Constant_Contact {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Constant Contact', 'charitable' );
		...
		public function sidebar_tab() {
			...
			$active = ( true === apply_filters( 'charitable_campaign_builder_marketing_sidebar_active', $this->active, $this->slug ) ) ? 'active' : false;
		...
		public function panel_content() {
			...
			<div class="charitable-panel-content-section charitable-panel-content-section-parent-marketing charitable-panel-content-section-<?php echo esc_attr( $this->slug ); ?> <?php echo esc_attr( $active ); ?>" style="<?php echo esc_attr( $style ); ?>">
				...
				<?php $panel->education_marketing_text( $this->primary_label, $this->slug, 'charitable-automation-connect' ); ?>
	...
	new Charitable_Builder_Panel_Marketing_Constant_Contact();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Hubspot' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Hubspot {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Hubspot', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Hubspot();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_Payfast' ) ) :

	/**
	 * Payfast subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Payment_Payfast {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Payfast', 'charitable' );
	...
	new Charitable_Builder_Panel_Payment_Payfast();

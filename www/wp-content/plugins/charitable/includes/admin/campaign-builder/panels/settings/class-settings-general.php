				...
				<?php
					...
					echo $charitable_builder_form_fields->generate_text(
						...
						array(
							...
							'placeholder' => '∞',
							'add_commas'  => true,
							'tooltip'     => esc_html__( 'Set a monetary goal that you want to raeach for this campaign. Leave blank for no goal.', 'charitable' ),
							'icon'        => 'images/campaign-builder/settings/goal_dollar.png',
						)
					);

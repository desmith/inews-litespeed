...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Integromat' ) ) :
	 ...
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Marketing_Integromat {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Integromat', 'charitable' );
	...
	new Charitable_Builder_Panel_Marketing_Integromat();

...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_Mollie' ) ) :

	/**
	 * Mollie subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Payment_Mollie {
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'Mollie', 'charitable' );
	...
	new Charitable_Builder_Panel_Payment_Mollie();

...
/**
 * Add custom css to body for campaign page.
 *
 * @see Charitable_Campaign_List_Table::admin_body_class()
 */
add_filter( 'admin_body_class', array( Charitable_Campaign_List_Table::get_instance(), 'admin_body_class' ) );

/**
 * Add the legacy add button above the campaigns table.
 *
 * @see Charitable_Campaign_List_Table::add_export()
 */
add_action( 'manage_posts_extra_tablenav', array( Charitable_Campaign_List_Table::get_instance(), 'add_legacy_link' ) );

...
if ( ! class_exists( 'Charitable_Public' ) ) :
	...
	final class Charitable_Public {
		...
		public function setup_scripts() {
			...
			// v2
			// wp_enqueue_style(
			// 'charitable-campaign-builder-theme-base',
			// $assets_dir . '/css/campaign-builder/themes/base.css',
			// array(),
			// $version
			// );

			// wp_enqueue_style(
			// 'charitable-campaign-builder-theme-default-1-col',
			// $assets_dir . '/css/campaign-builder/themes/default-1-col.css',
			// array(),
			// $version
			// );
			...
			/*
			 * Campaign Theme Scripts.
			 * //todo: only load the script for the template being used.
			 */
			// $theme_scripts = [
			// 'base',
			// ];
			...
			// wp_register_script(
			// 'charitable-campaign-theme-' . $script,
			// $assets_dir . 'js/campaign-builder/themes/' . $script . '' . $min . '.js',
			// array( 'jquery', 'charitable-frontend-v2' ),
			// $version,
			// true
			// );
			// wp_enqueue_script( 'charitable-campaign-theme-' . $script );
			// }
		}

...
if ( ! class_exists( 'Charitable_Post_Types' ) ) :
	...
	final class Charitable_Post_Types {
		...
		private function __construct() {
			...
			// Add "new" indicitator in admin menu.
			add_filter( 'charitable_campaign_post_type', [ $this, 'add_new_indicitator' ], 100 );
		}
		...
		public function add_new_indicitator( $post_type_args ) {
			...
			$post_type_args['labels']['menu_name'] = $post_type_args['labels']['menu_name'] . ' <span class="charitable-menu-new-indicator">&nbsp;NEW!</span>';
		...
		public function add_new_link_for_campaigns() {
			...
			if ( isset( $submenu['charitable'][2][2] ) ) {
				$submenu['charitable'][2][2] = 'edit.php?post_type=campaign&create=campaign'; // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
			}
		}
		...
		public function admin_header() {
			...
			if ( 'campaign' === $screen->post_type || 'donation' === $screen->post_type || 'charitable_page_charitable-settings' === $screen->base || 'charitable_page_charitable-addons' === $screen->base ) {

...
<?php echo $wrapper; ?> .charitable-campaign-field-donate-amount ul li.suggested-donation-amount.selected {
    border: 10px solid <?php echo $tertiary; ?> !important;
}
...
<?php echo $wrapper; ?> .charitable-campaign-tab-container .tab-content img {
  max-width: 100%;
}
<?php echo $wrapper; ?> .charitable-campaign-tab-container .tab-content > ul {
  margin-left: 0;
  margin-right: 0;
}

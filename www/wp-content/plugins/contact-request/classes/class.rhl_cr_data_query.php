...
class rhl_cr_data_query{

	private $table;
	
	public function __construct(){
	  global $wpdb;
	  $this->table = $wpdb->prefix.'contact_requests';
	}
	...
	*/
	public function getAllRecords($limit = 0) {
	  global $wpdb;
	  $sql = "SELECT $this->table.id,$this->table.rhl_cr_fname,$this->table.rhl_cr_lname,$this->table.rhl_cr_phone,$this->table.rhl_cr_email,$this->table.ip_addr,$this->table.rhl_cr_message,$this->table.added_on FROM {$this->table}";
	  if($limit > 0){
	  	$sql.= " LIMIT 0, $limit ";
	  }

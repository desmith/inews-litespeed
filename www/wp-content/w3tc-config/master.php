<?php exit; ?>{
    ...
    "dbcache.memcached.aws_autodiscovery": true,
    "dbcache.memcached.servers": [
        "inews-static.5yaur7.cfg.use1.cache.amazonaws.com:11211"
    ],
    ...
    "objectcache.memcached.aws_autodiscovery": true,
    ...
    "pgcache.engine": "nginx_memcached",
    ...
    "pgcache.memcached.aws_autodiscovery": true,
    ...
    "pgcache.migrated.qsexempts": 1689433852,
    ...
    "cdn.cf.cname": [],
    "cdn.cf.ssl": "auto",
    "cdn.cf.public_objects": "disabled",
    "cdn.cf2.key": "",
    "cdn.cf2.secret": "",
    "cdn.cf2.id": "",
    "cdn.cf2.cname": [],
    ...
    "cdnfsd.engine": "cloudfront",
    "cdnfsd.debug": false,
    "cdnfsd.cloudfront.access_key": "AKIA3RT27CBC4OB2PIOS",
    "cdnfsd.cloudfront.secret_key": "hPxBaHjLJLC\/zOJUJIbOyrYrF5bAkJPpi+Sc49lg",
    "cdnfsd.cloudfront.distribution_id": "E2JTWMP1TIEZ6P",
    ...
    "widget.pagespeed.access_token": "{\"access_token\":\"ya29.a0AfB_byBvarZia6ujBa151MUfnrxnKoSbmbde9rtBcyxhx4xJJwFbBYCT8HlNKBaUJfY-tvGlMYu-fPsmiJzuiZ46dk7iQ4gVJ35rRbOZg24nq9WaOVCE5zjmNiaKI2PJ2HUqzUunjGoiOyIx7Lyvoy9E-dJqqeR7YW69rboaCgYKAW8SARASFQHGX2Mi0FxdBUGtZ3ZyJS0TnCkqbg0174\",\"expires_in\":3599,\"scope\":\"openid\",\"token_type\":\"Bearer\",\"id_token\":\"eyJhbGciOiJSUzI1NiIsImtpZCI6IjkxNDEzY2Y0ZmEwY2I5MmEzYzNmNWEwNTQ1MDkxMzJjNDc2NjA5MzciLCJ0eXAiOiJKV1QifQ..aoXT7USxhoSx1aicQVBiXUL2Dbb-RLg-u3K2WCpfmKbIglG6m0bAGHRgmmrkuy3OdHGwi3k1JHi6F9wpvFaAtgKyBHY2QpZ-W5YUcf6MRg-TNcMOA1K7CJaQlzlWub0-q-wZ3b2dfgKAcHjy4LLxsZnQrtyyWGELPN8sBpparVDwkzSNbbyifetq6eeSWyGdLPmD3vr-wMThydRiZNDC28TlAd3c5eIVY72ASftGk45BmYSLU0l-wc2rUleGs_ylGlFfcYIWY-oZq0LHne0Jgf9xrbwvfp39MCnyh2v6jtFlY-6DD3_Wt1tOnUT-qzzm8Qi0RbxsLGmGjwDtb2og8A\",\"created\":1704040876}",
    "widget.pagespeed.w3tc_pagespeed_key": "b55b14c08947216d24aeaeb4901c2b45",
    ...
    "extensions.active_frontend": {
        "wordpress-seo": "*",
        "fragmentcache": "*",
        "user-experience-preload-requests": "*",
        "amp": "*",
        "cloudflare": "*",
        "imageservice": "*"
    },
    "extensions.active_dropin": [],
    "plugin.license_key": "0FM9uRfCSwgZZ988KHGTLqQwUPF1HJOQ",
    "plugin.type": "pro",
    ...
    "_wpnonce": "79e9a2a378",
    "_wp_http_referer": "\/wp-admin\/admin.php?page=w3tc_extensions&extension=cloudflare&action=view&w3tc_message=6590df9d185bb",
    ...
    "extension.user-experience-preload-requests": "1",
    ...
    "fragmentcache.memcached.servers": "inews-infra-5yaur7.serverless.use1.cache.amazonaws.com:11211",
    ...
    "health-check-disable-plugin-hash": "26d97851cd14ac13a35266e1f778c29c59ce542da1edda1423c83071f1181adb",
    "cdnfsd.cloudfront.distribution_domain": "d13kcv70nz7srl.cloudfront.net",
    "cloudflare": {
        "email": "devaprastha@iskcon.org",
        "key": "35944b5158d6a3697a5c51d3dec2db4f22f0c",
        "zone_id": "4ee24498f4fa7101706efad00568e675",
        "zone_name": "iskconnews.org",
        "widget_interval": "-30",
        "widget_cache_mins": "5",
        "pagecache": "1",
    ...
    "cloudflare_api_browser_cache_ttl": "14400",
    "cloudflare_api_challenge_ttl": "3600",
    "cloudflare_api_edge_cache_ttl": "7200",
    "cloudflare_api_rocket_loader": "on",
    "cloudflare_api_minify_js": "1",
    "cloudflare_api_minify_css": "1",
    "cloudflare_api_minify_html": "1",
    ...
    "cloudflare_api_hotlink_protection": "1",
    "cloudflare_api_mirage": "1",
    "cloudflare_api_polish": "lossless",
    ...
    "cloudflare_api_ssl": "flexible",
    "cloudflare_api_security_header": "1",

    ...
    <div class="title_wrap">
        ...
        <form class="allForm">
            <div class="form-element form-select">
                <?php $terms = get_terms('category', array( 'parent' => 35, 'orderby' => 'slug', 'hide_empty' => false ) ); 
                 ?>
                  <select onchange="location = this.value;">
                        <option value="<?php bloginfo('url'); ?>/category/outreach-activism/">Select topic</option>

                ...
                <div class="top_contentwrap">
                    ...
                    <div class="logo_area">
                        <a href="<?php bloginfo('url'); ?>/" class="iskcon__logo">
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/biglogo.png" class="logo__desktop" alt="ISKCON News" title="ISKCON News"/>
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/smalllogo.png" class="logo__mobile" alt="ISKCON News" title="ISKCON News"/>
                        </a>
                    </div>
                    <div class="right">
    ...
    <div class="bottom">
        <div class="main-container">
            <div class="inner-container">
                ...
                <div class="nav_btnG">
                    <a href="<?php bloginfo('url'); ?>/donation-page/" class="btn hvr:outline bg--yellow c--white hvr:bg--transparent hvr:c--yellow">Donate Now</a>
                    <a href="<?php bloginfo('url'); ?>/submit-your-story/" class="btn outline bg--transparent c--black hvr:bg--blue hvr:c--white">Submit Story</a>
                </div>
            </div>
        </div>
    </div>

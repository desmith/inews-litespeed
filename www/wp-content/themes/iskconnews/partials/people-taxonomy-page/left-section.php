    ...
    <div class="title_wrap">
        ...
        <form class="allForm">
            <div class="form-element form-select">
                <?php $terms = get_terms('category', array( 'parent' => 42, 'orderby' => 'slug', 'hide_empty' => false ) ); 
                 ?>
                  <select onchange="location = this.value;">
                        <option value="<?php bloginfo('url'); ?>/category/people/">Select topic</option>
            ...
            if(in_array('58', $term_ids)){ ?>
                            <div class="card">
                                <div class="box">
                                        ...
                                        <div class="cat"><span><?php echo get_the_date( 'M d, Y' ); ?></span></div>

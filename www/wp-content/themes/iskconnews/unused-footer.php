        ...
        <div class="main-container">
            <div class="inner-container">
                <div class="list">
                    ...
                    <div class="iskc">
                        <figure>
                            <img src="<?php bloginfo('template_url'); ?>/assets/img/iskc.png" alt="" title="">
                        </figure>
                    </div>
                ...
                <div class="main-container">
                    <div class="inner-container">
                        <ul>
                            ...
                            <li><a href="http://content.iskcon.org/icj/index.html" target="_blank">ISKCON Communications Journal</a></li>
                            <li><a href="https://iskconcommunications.org/" target="_blank">ISKCON Communications</a></li>
...
<div class="pop-up-overlay" style="display:none;">
  ...
  <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/assets/js/custom-file-input.js"></script>
     <?php wp_footer(); ?>
    </body>
</html>